...
void SGIntroPageManagement::initialiseintropage(){
    ...
    (*SGIntroPageManagement::intropagescrollview).setWidget(SGIntroPageManagement::intropagelayout);
